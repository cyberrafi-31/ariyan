...
░                                   ░                                ░ ░     
             ...
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : 𝐌𝐑-𝐑𝐀𝐅𝐈        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : 𝐜𝐲𝐛𝐞𝐫𝐫𝐚𝐟𝐢-𝟑𝟏        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : 𝑹𝑨𝑭𝑰 𝑪𝑯𝑶𝑾𝑫𝑯𝑼𝑹𝒀      \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801877721475     \033[1;93m▇▇
...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://youtube.com/@CyberTermuxZone4565')
    logo()
    print ('')
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/cyberrafi-31/ariyan/blob/main/Ariyan.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : 𝐌𝐑-𝐑𝐀𝐅𝐈 😈😈");time.sleep (0.03)
    print("             [*]. FACEBOOK   : 𝑹𝑨𝑭𝑰 𝑪𝑯𝑶𝑾𝑫𝑯𝑼𝑹𝒀");time.sleep (0.03)
    print("             [*]. GITHUB     : 𝐜𝐲𝐛𝐞𝐫𝐫𝐚𝐟𝐢-𝟑𝟏");time.sleep (0.03)   
