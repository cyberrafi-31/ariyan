...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m FACEBOOK  : 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘E 
...
def Main():
	...
	if opt in ["C","3"]:
		...
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801877721475');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/cyberrafi-31/ariyan/blob/main/mehedi.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=615514111164954")
        superuser()        
superuser()
